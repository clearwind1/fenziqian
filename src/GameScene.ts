...
class GameScene extends GameUtil.BassPanel {
    ...
    private showresb() {
        ...
        var lookphone: MyBitmap = new MyBitmap(RES.getRes('lookphone_jpg'), this.mStageW / 2, this.mStageH / 2);
        this.FirstContain.addChild(lookphone);
    ...
    private showresbtap(id) {
        ...
        egret.setTimeout(() => {
            if (id > 2) {
                ...
                console.log('id===', id);
                this.FirstContain.removeChild(img);
                hand.alpha = 0;
                hand2.alpha = 0;
                inputhand.alpha = 1;
                egret.setTimeout(() => { this.showresbtap(id) }, this, 1200)
            };
        }, this, 1000);
    }
    //画面5
    private showflfq() {
        ...
        egret.Tween.get(this.SecondContain).to({ alpha: 1 }, 500).call(() => {
            ...
            this.SecondContain.addChild(lyricpic);
            lyricpic.alpha = 0;
            egret.Tween.get(lyricpic).to({ alpha: 1 }, 700).wait(1400).call(() => {
    ...
    private showgzlight() {
        ...
        egret.Tween.get(this.FirstContain).to({ alpha: 1 }, 500).call(() => {
            ...
            egret.Tween.get(hand).to({ rotation: 1 }).wait(100).to({ rotation: 0 }).wait(100).to({ rotation: 1 }).wait(100).to({ rotation: 0 }).wait(1600).call(() => {
    ...
    private showscfif() {
        ...
        egret.Tween.get(this.FirstContain).to({ alpha: 0 }, 800).call(() => {
            egret.setTimeout(this.showscsit, this, 2200);
    ...
    private showscet() {
        ...
        egret.Tween.get(this.SecondContain).to({ alpha: 0 }, 500).call(() => {
            this.stage.scaleMode = egret.StageScaleMode.FIXED_WIDE;
            egret.Tween.get(this.FirstContain).to({ alpha: 1 }, 500).call(() => {
    ...
    private showscnt() {
        ...
        egret.Tween.get(this.FirstContain).to({ alpha: 0 }, 800).wait(500).call(() => {
            this.stage.scaleMode = egret.StageScaleMode.EXACT_FIT;
            egret.Tween.get(this.SecondContain).to({ alpha: 1 }, 800).call(() => {
    ...
    private showsctt() {
        ...
        egret.Tween.get(this.SecondContain).to({ alpha: 0 }, 800).wait(100).call(() => {
            egret.Tween.get(this.FirstContain).to({ alpha: 1 }, 800).call(() => {
    ...
    private showsctto() {
        ...
        //egret.Tween.get(this.SecondContain).to({ alpha: 1 }, 800);
        egret.Tween.get(this.FirstContain).to({ alpha: 0 }, 800).wait(100).call(() => {
            egret.Tween.get(this.SecondContain).to({ alpha: 1 }, 800).call(() => {
