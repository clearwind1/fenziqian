...
var GameHelpPageShow = (function (_super) {
    ...
    GameHelpPageShow.prototype.show = function () {
        this.config = {
            totalpage: 0,
            curpage: 0,
            bg: '',
        ...
        var self = this;
        /**总页数 */
        var helpPage = this.config['totalpage'];
        /**当前页 */
     ...
     * @curtag      帮助当前页数
     */
    GameHelpPageShow.prototype.helpcurcontain = function (helpcontain, helpbg, curtag) {
